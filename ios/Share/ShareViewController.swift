...
final class ShareViewController: UIViewController {
  ...
  private func save(url: String?, text: String?) async {
    ...
    let base = HoardConfigBaseURL()
    // Present the captured Access session so this separate extension process
    // also clears the Access edge.
    AccessCookieStore.installStored(baseURL: base)
  ...
  private func HoardConfigBaseURL() -> URL {
    ...
    #else
    return URL(string: "https://crawler.sharathchenna.top")!
    #endif
  }
}
